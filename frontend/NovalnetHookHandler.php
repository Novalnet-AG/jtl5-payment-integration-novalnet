...
HTML;
                    ...
                    if (strpos($payment->cModulId, 'novalnet')) {
                        ...
                        <script type='text/javascript' src='{$pluginPath}frontend/js/novalnet_cc_logo.min.js'  integrity='sha384-pODtlmk4kHBW0tTF2xjWP0hkXB30pzMZje41WKCFAR21oalFl9HmxtQVLLNaU9Cs'></script>
...
HTML;
        ...
        $nnWalletScript .= <<<HTML
                    ...
                    <script type='text/javascript' src='{$pluginPath}frontend/js/novalnet_wallet_helper.min.js'  integrity='sha384-0vMdhDV2P3opCFzF/C9tKhEQ3nvNaAVRivpwEKlveKObVdtWtDUCGexznblnA+CC'></script>
