...
<input type="hidden" name="nn_postfinance_api_configure" id="nn_postfinance_api_configure" value="{$languageTexts.jtl_novalnet_postfinance_configuration_text}">
<input type="hidden" name="nn_postfinance_card_api_configure" id="nn_postfinance_card_api_configure" value="{$languageTexts.jtl_novalnet_postfinance_card_configuration_text}">
<input type="hidden" name="nn_invalid_google_pay_merchant_id" id="nn_invalid_google_pay_merchant_id" value="{$languageTexts.jtl_novalnet_google_pay_merchant_id_error}">
<input type="hidden" name="nn_shop_name" id="nn_shop_name" value="{$shopName}">
...
<script type="text/javascript" src="{$adminUrl}js/novalnet_admin.min.js"   integrity="sha384-+JFBM//O4m7DyQoyEJFETALUcFixNxsXLDMlhXq56IZXuxPCC+hTNBK9WE3KoASM" ></script>
