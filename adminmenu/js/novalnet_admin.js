jQuery(document).ready(function() {
        ...
        jQuery('button[name=speichern]').on('click', function(event){
            // Validate the Google Pay merchant ID
            if(jQuery(paymentSettings).hasClass('active')) {
                if(jQuery('#novalnet_googlepay_merchant_id').val() == '') {
                    handleErrorElement(jQuery('#novalnet_googlepay_merchant_id'), jQuery('#nn_invalid_google_pay_merchant_id').val());
                }
            }
