...
class NovalnetBackendTabRenderer
{
    ...
    {
        $getOrder = $this->db->queryPrepared('SELECT ord.kBestellung, ord.cKommentar, ord.kSprache FROM tbestellung ord JOIN xplugin_novalnet_transaction_details nov ON ord.cBestellNr = nov.cNnorderid WHERE cNnorderid = :cNnorderid', ['cNnorderid' => $post['order_no']], ReturnType::SINGLE_OBJECT);
