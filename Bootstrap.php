...
class Bootstrap extends Bootstrapper
{
    ...
    public function boot(Dispatcher $dispatcher): void
    {
        ...
        if (Shop::isFrontend()) {
            ...
            $dispatcher->listen('shop.hook.' . \HOOK_WARENKORB_PAGE, [$novalnetHookHandler, 'displaywalletpayments']);
            $dispatcher->listen('shop.hook.' . \HOOK_ARTIKEL_PAGE, [$novalnetHookHandler, 'displaywalletpayments']);
            ...
            $dispatcher->listen('shop.hook.' . \HOOK_IO_HANDLE_REQUEST, function (array $args) {
                if (!isset($args['io']) || !isset($args['request'])) {
                    return;
                }
