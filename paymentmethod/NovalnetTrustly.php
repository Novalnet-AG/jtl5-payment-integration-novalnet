...
/**
 * Class NovalnetTrustly
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetTrustly extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_trustly';
    
    /**
     * NovalnetTrustly constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet Trustly';
        $this->caption = 'Novalnet Trustly';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'TRUSTLY';
