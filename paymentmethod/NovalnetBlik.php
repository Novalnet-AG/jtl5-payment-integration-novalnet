 ...
 */
class NovalnetBlik extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_blik';
    
    /**
     * NovalnetBlik constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet Blik';
        $this->caption = 'Novalnet Blik';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'BLIK';
