...
<fieldset>
    ...
    <div class="nn_ach">
        ...
        <div class="row" id="nn_load_new_form">
			 <div class="form-group col col-7 nn_account_field" role="group">
                <input type="text" class="form-control nn_ach_account_holder" id="nn_ach_account_holder" name="nn_ach_account_holder" size="32" autocomplete="off" value= "{$firstName} {$lastName}" >
                <label for="nn_ach_account_holder" class="col-form-label pt-0 nn_account_holder_label">{$languageTexts.jtl_novalnet_account_holder_name}</label>
            </div>
            <div class="form-group col col-7 nn_account_no_field" role="group">
                <input type="text" class="form-control nn_ach_account_no" id="nn_ach_account_no" name="nn_ach_account_no" size="32" autocomplete="off">
                <label for="nn_ach_account_no" class="col-form-label pt-0 nn_account_number_label">{$languageTexts.jtl_novalnet_ach_account_number}</label>
            </div>
            <div class="form-group col col-7 nn_routing_no_field" role="group">                
                <input type="text" class="form-control nn_ach_routing_no" id="nn_ach_routing_no" name="nn_ach_routing_no" size="32" autocomplete="off">
                <label for="nn_ach_routing_no" class="col-form-label pt-0 nn_routing_number_label">{$languageTexts.jtl_novalnet_sepa_routing_number}</label>
            </div>
        </div>
