...
<fieldset>
    ...
    <script type="text/javascript" src="{$pluginPath}paymentmethod/js/novalnet_payment_form.min.js"   integrity="sha384-XzW9i/tTwYQnRVtvQYwlGVkjHLgK0pqQrQOksEGeeOaZhKLOJG0mEQLplMDWMWk0"  ></script></script>
