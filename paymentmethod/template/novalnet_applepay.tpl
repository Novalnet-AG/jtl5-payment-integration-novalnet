...
<script type="text/javascript" src="{$pluginPath}paymentmethod/js/novalnet_wallet_payment.js"  integrity="sha384-rramnsStOM9Da//m3AW8kj2aaw9K8YkK+0w6fhbD7DFlGBM+zCRepfEg+mWQiAjo" defer></script>
