...
/**
 * Class NovalnetAlipay
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetAlipay extends Method
{
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_alipay';

    /**
     * NovalnetAlipay constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet Alipay';
        $this->caption = 'Novalnet Alipay';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'ALIPAY';
