...
class NovalnetDirectDebitACH extends Method
{
    ...
    public function handleAdditional(array $post): bool
    {
        ...
        if ($this->novalnetPaymentGateway->novalnetPaymentHelper->getConfigurationValues('one_click_shopping', $this->paymentName) && (Frontend::getCustomer()->kKunde) != '') {
            ...
            $AccountDetails = $this->novalnetPaymentGateway->novalnetPaymentHelper->getPaymentReferenceValues($this->paymentName);
        }

        $languageTexts = $this->novalnetPaymentGateway->novalnetPaymentHelper->getNnLanguageText(['jtl_novalnet_ach_account_number', 'jtl_novalnet_sepa_routing_number', 'jtl_novalnet_account_number_invalid', 'jtl_novalnet_routing_number_invalid', 'jtl_novalnet_account_name_empty','jtl_novalnet_account_holder_invalid', 'jtl_novalnet_account_holder_name', 'jtl_novalnet_save_account_data', 'jtl_novalnet_add_new_account_details', 'jtl_novalnet_remove_account_detail', 'jtl_novalnet_account_detail_removed',]);
