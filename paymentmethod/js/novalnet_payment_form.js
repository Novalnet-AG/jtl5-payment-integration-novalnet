...
jQuery(document).ready(function () {
                ...
                if (jQuery('#nn_load_new_form').css('display') !== 'none') {
					if(jQuery('#nn_ach_account_holder').val() == '' || jQuery('#nn_ach_account_no').val() == '' || jQuery('#nn_ach_routing_no').val() == '') { 
                        if(jQuery('#nn_ach_account_holder').val() == '') {
							jQuery('#novalnet_ach_holder_error_alert').text(jQuery('#nn_account_holder_invalid').val());
							jQuery('#novalnet_ach_holder_error_alert').show();
							setTimeout(function() {
								jQuery('#novalnet_ach_holder_error_alert').hide(); 
							}, 3000);
							jQuery('#novalnet_ach_holder_error_alert').removeClass('d-none'); 
							jQuery('.submit_once').removeAttr('disabled');   
						}
    ...
    jQuery('.nn_holder').on('input', function() {
