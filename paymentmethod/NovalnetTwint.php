 ...
 */
class NovalnetTwint extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_twint';
    
    /**
     * NovalnetTwint constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet TWINT';
        $this->caption = 'Novalnet TWINT';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'TWINT';
