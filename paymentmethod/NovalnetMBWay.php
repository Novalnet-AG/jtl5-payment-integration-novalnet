 ...
 */
class NovalnetMBWay extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_mbway';
    
    /**
     * NovalnetMBWay constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet MBWay';
        $this->caption = 'Novalnet MBWay';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'MBWAY';
