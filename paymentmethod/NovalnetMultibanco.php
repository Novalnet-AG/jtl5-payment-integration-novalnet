...
{     
    ...
    {
        $multibancoComments  = \PHP_EOL . sprintf($this->novalnetPaymentGateway->novalnetPaymentHelper->plugin->getLocalization()->getTranslation('jtl_novalnet_multibanco_reference_text'), number_format($paymentResponse['transaction']['amount'] / 100 , 2, ',', ''), $paymentResponse['transaction']['currency'] );
