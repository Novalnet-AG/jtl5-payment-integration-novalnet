...
/**
 * Class NovalnetPayconiq
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetPayconiq extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_payconiq';
    
    /**
     * NovalnetPayconiq constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet Payconiq';
        $this->caption = 'Novalnet Payconiq';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'PAYCONIQ';
