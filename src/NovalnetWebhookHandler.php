...
class NovalnetWebhookHandler
{
    ...
    public function getOrderReference(): object
    {
        ...
        $novalnetOrder = Shop::Container()->getDB()->queryPrepared('SELECT cNnorderid, cZahlungsmethode, cStatuswert, nBetrag, nNntid FROM xplugin_novalnet_transaction_details WHERE cNnorderid   = :cNnorderid', [':cNnorderid' => $this->eventData['transaction']['order_no']], ReturnType::SINGLE_OBJECT);
