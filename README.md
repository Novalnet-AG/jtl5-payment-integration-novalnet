...
The module is available for the 5.0.0 - 5.5.3 versions in the following languages: EN & DE and requires PHP versions 7.3 and higher. 
...
* One click shopping supported Credit/Debit Cards, Direct Debit SEPA & Direct Debit ACH
